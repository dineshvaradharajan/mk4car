...
const TRACKS = [
    { name: 'Interlagos', desc: 'Brazilian GP classic', difficulty: 'Easy', unlock: 0,
    ...
    { name: 'Austin COTA', desc: 'Texan uphill esses', difficulty: 'Easy', unlock: 25,
    ...
    { name: 'Mugello', desc: 'Tuscan hill flow', difficulty: 'Medium', unlock: 50,
    ...
    { name: 'Mexico Hermanos', desc: 'Stadium + Peraltada', difficulty: 'Medium', unlock: 100,
    ...
    { name: 'Hockenheim', desc: 'German forest stadium', difficulty: 'Medium', unlock: 150,
      skyColor: 0x99bbdd, groundColor: 0x6b7a3a, fogColor: 0xaabbcc, fogDensity: 0.004,
    ...
    { name: 'Miami Gardens', desc: 'Sunshine state twist', difficulty: 'Hard', unlock: 200,
    ...
    { name: 'Red Bull Ring', desc: 'Austrian alpine sprint', difficulty: 'Hard', unlock: 300,
